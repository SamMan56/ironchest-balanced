...
public class IronChestsRecipeProvider extends RecipeProvider implements IConditionBuilder {
  ...
  private void addChestsRecipes(Consumer<FinishedRecipe> consumer) {
    ...
    ShapelessRecipeBuilder.shapeless(IronChestsBlocks.IRON_CHEST.get())
      .requires(Tags.Items.INGOTS_IRON)
      .requires(Tags.Items.CHESTS_WOODEN)
      .unlockedBy("has_iron_ingot", has(Tags.Items.INGOTS_IRON))
      .save(consumer, location(folder + "vanilla_iron_chest"));

    ShapelessRecipeBuilder.shapeless(IronChestsBlocks.GOLD_CHEST.get())
      .requires(Tags.Items.INGOTS_GOLD)
      .requires(IronChestsBlocks.IRON_CHEST.get())
      .unlockedBy("has_gold_ingot", has(Tags.Items.INGOTS_GOLD))
      .save(consumer, location(folder + "iron_gold_chest"));

    ShapelessRecipeBuilder.shapeless(IronChestsBlocks.DIAMOND_CHEST.get())
    ...
    ShapelessRecipeBuilder.shapeless(IronChestsBlocks.OBSIDIAN_CHEST.get())
      .requires(Blocks.OBSIDIAN)
      .requires(IronChestsBlocks.DIAMOND_CHEST.get())
      .unlockedBy("has_obsidian", has(Blocks.OBSIDIAN))
      .save(consumer, location(folder + "diamond_obsidian_chest"));

    ShapelessRecipeBuilder.shapeless(IronChestsBlocks.CRYSTAL_CHEST.get())
      .requires(Tags.Items.GLASS)
      .requires(IronChestsBlocks.DIAMOND_CHEST.get())
      .unlockedBy("has_glass", has(Tags.Items.GLASS))
      .save(consumer, location(folder + "diamond_crystal_chest"));

    ShapelessRecipeBuilder.shapeless(IronChestsBlocks.DIRT_CHEST.get())
      .requires(Ingredient.of(Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL))
      .requires(Tags.Items.CHESTS_WOODEN)
    ...
    ConditionalRecipe.builder()
      ...
      .addRecipe(ShapelessRecipeBuilder.shapeless(IronChestsBlocks.IRON_CHEST.get())
        .requires(Tags.Items.INGOTS_IRON)
        .requires(IronChestsBlocks.COPPER_CHEST.get())
    ...
    ConditionalRecipe.builder()
      .addCondition(not(new TagEmptyCondition("forge:ingots/copper")))
      .addRecipe(ShapelessRecipeBuilder.shapeless(IronChestsBlocks.COPPER_CHEST.get())
        .requires(INGOTS_COPPER)
        .requires(Tags.Items.CHESTS_WOODEN)
